...
#include "../BOMGraphicalLibrary/signalGraphicsItemWithText.h"
#include "../BOMGraphicalLibrary/steamGraphicsItemWithText.h"
#include "../BOMGraphicalLibrary/genericGraphicsItemWithText.h"
#include <qplugin.h>
...
class IBOMInstanceCreation
 ...
 public:
     ...
     virtual signalGraphicsItemWithText* createSignalWithText(QPoint position,QString UserDefName="Signal")=0;
     virtual  steamGraphicsItemWithText* createHeatSteamTransferWithText(QPoint position,QString UserDefName="Signal")=0;
    virtual  genericGraphicsItemWithText* createGenericGraphicItemWithText(QPoint position,QString UserDefName="",QString iconName="")=0;
