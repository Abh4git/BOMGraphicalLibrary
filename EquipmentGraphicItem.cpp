...
EquipmentGraphicItem::EquipmentGraphicItem   (QGraphicsItem *parent):
    QGraphicsPolygonItem(parent)
{

    deviceGraphic << QPointF(_startX-140, _startY-140) << QPointF(_startX+140, _startY -140)
                  << QPointF(_startX+140, _startY+140) << QPointF(_startX-140,_startY +140)
                  << QPointF(_startX-140, _startY-140);
...
EquipmentGraphicItem::EquipmentGraphicItem(QGraphicsItem *parent, int startX, int startY)
{
    this->_startX=startX;
    this->_startY=startY;
    deviceGraphic << QPointF(_startX-140, _startY-140) << QPointF(_startX+140, _startY -140)
...
EquipmentGraphicItem::EquipmentGraphicItem(BOMObject *typeOfBOM, QGraphicsItem *parent, int startX, int startY,int endX)
{
    this->_startX=startX;
    this->_startY=startY;
	...
	if (endX==0)
	{
    deviceGraphic << QPointF(_startX-140, _startY-140) << QPointF(_startX+25, _startY -140)
                  << QPointF(_startX+25, _startY+25) << QPointF(_startX-140,_startY +25)
                  << QPointF(_startX-140, _startY-25);
	} else
	{
